...
const Banner = () => {
  ...
  return (
    <section className="px-0 md:px-[40px] mt-[64px]">
      <div className="bg-[url('https://images.pexels.com/photos/772803/pexels-photo-772803.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2')] h-[659px] w-full bg-cover bg-center flex justify-center items-center bg-[#00000033] bg-blend-overlay">
        <div
          ref={container}
          className="max-w-[963px] text-white px-[30px] xl:px-0">
          <h2
            className={`text-[30px] md:text-[44px] leading-[40px] md:leading-[46px] text-center md:text-left pr-[60px] pl-[20px] mb-[25px] opacity-0 translate-y-[100px] ${aileronFont.className}`}>
            {" "}
          ...
          <div className="relative opacity-0 translate-y-[100px] ">
            <input
              ...
              className="text-black w-full h-[60px] bg-white rounded-[60px] border-none text-[18px] md:text-[22px] pl-8 placeholder:text-black focus:outline-none"
            />
            <BiSearchAlt2 className="absolute top-5 right-6 text-black text-2xl" />
          </div>
          <p className="  pl-[30px] mb-0 mt-6 opacity-0 translate-y-[100px]">
            <b>Recommended: </b>
